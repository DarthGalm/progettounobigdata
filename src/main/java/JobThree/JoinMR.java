...
public class JoinMR {
    ...
    public static class ReducerJoin extends Reducer<Text, Text, Text, Text> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
                ...
                if(cols[0].equals("hsp")){ //sto elaborando dati da historical stock prices
                    ...
                    switch (year) {
                        ...
                        case 2018 :
                            ...
                            break;
                        default : System.out.println("Errore di parsing dell' anno per ticker: " + key.toString());
                    }
            ...
            String yearAndVariation2016 = String.format("%s:%d","2016",Double.isNaN(percentVariation2016) ? 0 : percentVariation2016.longValue());
            String yearAndVariation2017 = String.format("%s:%d","2017",Double.isNaN(percentVariation2017) ? 0 : percentVariation2017.longValue());
            String yearAndVariation2018 = String.format("%s:%d","2018",Double.isNaN(percentVariation2018) ? 0 : percentVariation2018.longValue());
